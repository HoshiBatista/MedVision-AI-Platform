"""
Pneumonia Detection — Export trained model to ONNX (opset 17).

Usage:
    python export_onnx.py --weights runs/pneumonia_detection/train/weights/best.pt
...
TRITON_DEST = ROOT / "triton_models" / "pneumonia_detection" / "1"
