"""
MRI Segmentation — Inference benchmark: latency & throughput.

Usage:
    python benchmark.py --weights best.pt
    python benchmark.py --weights best.pt --imgsz 640 --runs 200
    python benchmark.py --weights best.pt --onnx   # benchmark ONNX model
"""
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--runs",    type=int, default=100, help="Number of inference passes")
    p.add_argument("--warmup",  type=int, default=10,  help="Warmup passes (excluded from stats)")
    p.add_argument("--batch",   type=int, default=1)
    p.add_argument("--onnx",    action="store_true", help="Benchmark ONNX model instead")
    return p.parse_args()
