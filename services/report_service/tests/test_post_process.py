"""Unit tests for report post-processing (torch stubbed via conftest)."""
...
def test_post_process_trims_incomplete_tail_and_appends_disclaimer():
    result = _post_process("Clinical context.", "  This is   complete. Trailing incomplete")
